...
use Alves\Pix\Contracts\KeyValidations\PerformKeyValidations;
...
class Validator implements PerformKeyValidations
{
    ...
    {
        $phone = str_replace(config('laravel-psp-pix.country_phone_prefix', '+55'), '', $phone);
        $phone = preg_replace('/[^\d]+/', '', $phone);
        $phone = config('laravel-psp-pix.country_phone_prefix', '+55').$phone;
