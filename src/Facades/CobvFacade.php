...
namespace Alves\Pix\Facades;

use Illuminate\Support\Facades\Facade;
use Alves\Pix\Api\Features\Cobv\Cobv;
use Alves\Pix\Api\Features\Cobv\CobvRequest;
use Alves\Pix\Api\Features\Cobv\UpdateCobvRequest;
