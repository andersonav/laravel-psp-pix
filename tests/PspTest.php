...
use Alves\Pix\Exceptions\Psp\InvalidPspException;
...
class PspTest extends TestCase
{
    ...
    {
        config(['laravel-psp-pix.psp' => ['test' => [], 'test-2' => ['dummy_key' => 'dummy_value'], 'dummy_psp' => []]]);
    ...
    {
        config(['laravel-psp-pix.psp' => ['default' => [], 'dummy-psp' => []]]);
